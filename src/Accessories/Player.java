...
public class Player extends MapObject {
	...
	public Player(TileAccessories tm) {
		...
		sfx.put("jump",new AudioPlayer("/SFX/wav/updraft.wav"));
		sfx.put("scratch",new AudioPlayer("/SFX/wav/scratch.wav"));
		sfx.put("fire",new AudioPlayer("/SFX/wav/jett sound kinves.wav"));
		sfx.put("explosion",new AudioPlayer("/SFX/wav/sound kill.wav"));
	}
	...
	public int getKnives() { return knives; }
	public int getMaxKnives() { return maxKnives; }
	public void setKnives(int fire){this.knives = fire;}
	public boolean isDead(){return dead;}
	public void setLevel(int level){this.level = level;}
	public void setHealth(int health){this.health = health;}
	public int getLevel() { return level;}
	public void setMaxKnives(int maxFire){this.maxKnives = maxFire;knives = maxFire;}
	public void setLives(int lives){this.lives = lives;}
	public void increaseHealth(int health){this.health += health;}
    public void increaseAmmo(int knives){this.knives+=knives;}
	public void setFireDelay(int fireDelay){this.fireDelay = fireDelay;}
	public void setKnivesRegen(int fireRegen){this.knivesRegen = fireRegen;}
	...
	public void update() {
		...
		knives += knivesRegen;
		if(knives > maxKnives) knives = maxKnives;

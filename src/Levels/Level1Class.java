...
public class Level1Class extends GameController {
	...
	public void init() {
		...
		bgMusic = new AudioPlayer("/Music/wav/icebox.wav");
		item = new AudioPlayer("/SFX/wav/pick_item.wav");
		if(!player.getMute())
		{
			bgMusic.loop();
		}
	...
	public void update() {
		...
		if (gsm.motion == ACTIVE){player.update();}
	...
	public void setMotion(boolean b){this.paused = b;}
	public boolean getMotion(){return paused;}
